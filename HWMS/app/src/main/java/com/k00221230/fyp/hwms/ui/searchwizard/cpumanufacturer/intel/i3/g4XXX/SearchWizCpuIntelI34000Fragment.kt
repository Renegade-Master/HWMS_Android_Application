...
class SearchWizCpuIntelI34000Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_searchwiz_next).setOnClickListener {
            ...
            val action = SearchWizCpuIntelI34000FragmentDirections
                .actionSearchWizCpuIntelI34000FragmentToSearchWizResultsFragment(term)
            NavHostFragment.findNavController(this@SearchWizCpuIntelI34000Fragment)
                .navigate(action)
        }
    }
}
