package com.k00221230.fyp.hwms.ui.searchwizard.cpumanufacturer.intel.i5.g9XXX
...
class SearchWizCpuIntelI59000Fragment : Fragment() {

    private val args: SearchWizCpuIntelI59000FragmentArgs by navArgs()

    private lateinit var SearchWizCpuIntelI59000ViewModel: SearchWizViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_searchwiz_cpu_intel_i5_9000, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_searchwiz_next).setOnClickListener {
            ...
            val action = SearchWizCpuIntelI59000FragmentDirections
                .actionSearchWizCpuIntelI59000FragmentToSearchWizResultsFragment(term)
            NavHostFragment.findNavController(this@SearchWizCpuIntelI59000Fragment)
                .navigate(action)
        }
    }
}
