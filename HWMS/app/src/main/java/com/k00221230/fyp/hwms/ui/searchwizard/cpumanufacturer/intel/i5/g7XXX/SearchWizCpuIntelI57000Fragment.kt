...
package com.k00221230.fyp.hwms.ui.searchwizard.cpumanufacturer.intel.i5.g7XXX
...
class SearchWizCpuIntelI57000Fragment : Fragment() {

    private val args: SearchWizCpuIntelI57000FragmentArgs by navArgs()

    private lateinit var SearchWizCpuIntelI57000ViewModel: SearchWizViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_searchwiz_cpu_intel_i5_7000, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_searchwiz_next).setOnClickListener {
            ...
            val action = SearchWizCpuIntelI57000FragmentDirections
                .actionSearchWizCpuIntelI57000FragmentToSearchWizResultsFragment(term)
            NavHostFragment.findNavController(this@SearchWizCpuIntelI57000Fragment)
                .navigate(action)
        }
    }
}
