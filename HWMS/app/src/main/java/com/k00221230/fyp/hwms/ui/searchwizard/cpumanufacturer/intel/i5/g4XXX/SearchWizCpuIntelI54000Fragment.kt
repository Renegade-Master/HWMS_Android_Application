package com.k00221230.fyp.hwms.ui.searchwizard.cpumanufacturer.intel.i5.g4XXX
...
class SearchWizCpuIntelI54000Fragment : Fragment() {

    private val args: SearchWizCpuIntelI54000FragmentArgs by navArgs()

    private lateinit var SearchWizCpuIntelI54000ViewModel: SearchWizViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_searchwiz_cpu_intel_i5_4000, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_searchwiz_next).setOnClickListener {
            ...
            val action = SearchWizCpuIntelI54000FragmentDirections
                .actionSearchWizCpuIntelI54000FragmentToSearchWizResultsFragment(term)
            NavHostFragment.findNavController(this@SearchWizCpuIntelI54000Fragment)
                .navigate(action)
        }
    }
}
