package com.k00221230.fyp.hwms.ui.searchwizard.cpumanufacturer.intel.i7.g7XXX
...
class SearchWizCpuIntelI77000Fragment : Fragment() {

    private val args: SearchWizCpuIntelI77000FragmentArgs by navArgs()

    private lateinit var SearchWizCpuIntelI77000ViewModel: SearchWizViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_searchwiz_cpu_intel_i7_7000, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_searchwiz_next).setOnClickListener {
            ...
            val action = SearchWizCpuIntelI77000FragmentDirections
                .actionSearchWizCpuIntelI77000FragmentToSearchWizResultsFragment(term)
            NavHostFragment.findNavController(this@SearchWizCpuIntelI77000Fragment)
                .navigate(action)
        }
    }
}
