...
class SearchWizCpuIntelI99000Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_searchwiz_next).setOnClickListener {
            ...
            val action = SearchWizCpuIntelI99000FragmentDirections
                .actionSearchWizCpuIntelI99000FragmentToSearchWizResultsFragment(term)
            NavHostFragment.findNavController(this@SearchWizCpuIntelI99000Fragment)
                .navigate(action)
        }
    }
}
