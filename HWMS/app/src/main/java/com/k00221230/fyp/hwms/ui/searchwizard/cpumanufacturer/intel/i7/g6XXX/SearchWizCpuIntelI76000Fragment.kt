...
package com.k00221230.fyp.hwms.ui.searchwizard.cpumanufacturer.intel.i7.g6XXX
...
class SearchWizCpuIntelI76000Fragment : Fragment() {

    private val args: SearchWizCpuIntelI76000FragmentArgs by navArgs()

    private lateinit var SearchWizCpuIntelI76000ViewModel: SearchWizViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_searchwiz_cpu_intel_i7_6000, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_searchwiz_next).setOnClickListener {
            ...
            val action = SearchWizCpuIntelI76000FragmentDirections
                .actionSearchWizCpuIntelI76000FragmentToSearchWizResultsFragment(term)
            NavHostFragment.findNavController(this@SearchWizCpuIntelI76000Fragment)
                .navigate(action)
        }
    }
}
