package com.k00221230.fyp.hwms.ui.searchwizard.cpumanufacturer.intel.i5.g8XXX
...
class SearchWizCpuIntelI58000Fragment : Fragment() {

    private val args: SearchWizCpuIntelI58000FragmentArgs by navArgs()

    private lateinit var SearchWizCpuIntelI58000ViewModel: SearchWizViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_searchwiz_cpu_intel_i5_8000, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_searchwiz_next).setOnClickListener {
            ...
            val action = SearchWizCpuIntelI58000FragmentDirections
                .actionSearchWizCpuIntelI58000FragmentToSearchWizResultsFragment(term)
            NavHostFragment.findNavController(this@SearchWizCpuIntelI58000Fragment)
                .navigate(action)
        }
    }
}
